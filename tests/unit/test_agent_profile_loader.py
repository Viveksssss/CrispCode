...
from crispcode.core.agents.loader import AgentProfileLoader
...
# 设计：在 .crispcode/agents/ 中写入同名 TOML，monkeypatch cwd，断言加载到本地版本
def test_project_overrides_builtin(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    local_agents = tmp_path / ".crispcode" / "agents"
