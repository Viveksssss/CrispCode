...
class EventSubscribeCommand(BaseModel):
    ...
    scope: str = "global"  #   # "global" | "run:<runs_id>"
    replayed_from_run: str | None = None  # 设置则先从 events.jsonl 回放历史再接实时流
...
Command = Annotated[
    PingCommand | AgentRunCommand | EventSubscribeCommand, Discriminator("type")
]
