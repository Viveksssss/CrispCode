...
class McpClient:
    ...
    async def initialize(self) -> None:
        ...
        await self._notify("notifycations/initialized", {})
    ...
    async def _drain_stderr(self) -> None:
        ...
        try:
            while True:
                ...
                if stderr_line:
                    logger.debug("mcp stderr: %s", stderr_line)
    ...
    async def _call(self, method: str, params: dict[str, Any]) -> dict[str, Any]:
        ...
        async with self._lock:
            ...
            while True:
                ...
                if msg_id is None:
                    logger.debug(
                        "mcp: received server notification: %s", msg.get("method")
                    )
                    continue
    ...
    async def _write_line(self, line: str) -> None:
        ...
        if w is None:
            raise McpServerUnavailableError("writer unavailable")
        w.write(data)
        await w.drain()
